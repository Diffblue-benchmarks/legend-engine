...
public class PureModelContextPointerDiffblueTest {
  ...
  public void testCombine() {
    ...
    PureModelContextPointer pureModelContextPointer1 = new PureModelContextPointer();

    // Act
    PureModelContextPointer actualCombineResult = pureModelContextPointer.combine(pureModelContextPointer1);

    // Assert
    assertEquals(pureModelContextPointer1, actualCombineResult);
